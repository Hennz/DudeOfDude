 ...
 * @see net.it_tim.dude_of_dude.db_classes.Users
...
public class UsersHome extends DAO {
	...
	public Users findById(int id) {
		...
		try {
			Users instance = (Users) getCurrentSession().get(
					"net.it_tim.dude_of_dude.db_classes.Users", id);
			if (instance == null) {
	...
	public List<Users> findByExample(Users instance) {
		...
		try {
			List<Users> results = (List<Users>) getCurrentSession().createCriteria(
							"net.it_tim.dude_of_dude.db_classes.Users").add(
	...
	public boolean checkPassword( String login, String password ) {
		Users user = (Users) getCurrentSession().createCriteria("net.it_tim.dude_of_dude.db_classes.Users")
