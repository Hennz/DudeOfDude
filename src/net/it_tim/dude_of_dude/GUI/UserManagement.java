...
public class UserManagement extends JDialog {
	...
	public UserManagement() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(UserManagement.class.getResource("/net/it_tim/dude_of_dude/icons/Papermart/ID.png")));
		...
		btnAddUser.setIcon(new ImageIcon(UserManagement.class.getResource("/net/it_tim/dude_of_dude/icons/Signage/Add_Square.png")));
		...
		btnRemoveUser.setIcon(new ImageIcon(UserManagement.class.getResource("/net/it_tim/dude_of_dude/icons/Signage/Remove_Square.png")));
		...
		btnModifyUser.setIcon(new ImageIcon(UserManagement.class.getResource("/net/it_tim/dude_of_dude/icons/Papermart/Highlighter.png")));
		...
		btnOk.setIcon(new ImageIcon(UserManagement.class.getResource("/net/it_tim/dude_of_dude/icons/Signage/OK.png")));
		...
		btnCancel.setIcon(new ImageIcon(UserManagement.class.getResource("/net/it_tim/dude_of_dude/icons/Signage/Close.png")));
